...
from fdtdx.constraints.continuous import PillarMapping
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=str2bool,
        default=True,
        help="Whether to use multiple (2) polymers"
    )
...
def main(
        ...
        constraint_mapping=ConstraintMapping(
            ...
            discrete_modules=[
                ConnectHolesAndStructures(
                    fill_material="SZ2080" if multi_material else "maN1400"
                )
            ] if dim == "3d" else [],
        ),
    ...
    waveguide = WaveGuide(
        partial_real_shape=(None, 1.e-6, 1.e-6),
