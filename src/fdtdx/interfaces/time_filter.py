...
class TimeStepFilter(DataClass, ABC):
    ...
    _time_steps_max: int = static_private_field()
    _array_size: int = static_private_field()
    _input_shape_dtypes: dict[str, jax.ShapeDtypeStruct] = static_private_field()
    _output_shape_dtypes: dict[str, jax.ShapeDtypeStruct] = static_private_field()
...
class LinearReconstructEveryK(TimeStepFilter):
    ...
    _save_time_steps: jax.Array = static_private_field(default=None)  # type: ignore
    _time_to_arr_idx: jax.Array = static_private_field(default=None)  # type: ignore
