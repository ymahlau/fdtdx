...
kV_unit = Unit(scale=6, dim={SI.kg: 1, SI.m: 2, SI.s: -3, SI.A: -1})
V_unit = Unit(scale=6, dim={SI.kg: 1, SI.m: 2, SI.s: -3, SI.A: -1})
mV_unit = Unit(scale=6, dim={SI.kg: 1, SI.m: 2, SI.s: -3, SI.A: -1})
