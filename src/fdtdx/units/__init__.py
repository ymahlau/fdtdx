...
MW = Unitful(val=1, unit=MW_unit)
kW = Unitful(val=1, unit=kW_unit)
W = Unitful(val=1, unit=W_unit)
mW = Unitful(val=1, unit=mW_unit)
uW = Unitful(val=1, unit=uW_unit)
...
kV = Unitful(val=1, unit=kV_unit)
V = Unitful(val=1, unit=V_unit)
mV = Unitful(val=1, unit=mV_unit)
uV = Unitful(val=1, unit=uV_unit)
...
kA = Unitful(val=1, unit=kA_unit)
A = Unitful(val=1, unit=A_unit)
mA = Unitful(val=1, unit=mA_unit)
uA = Unitful(val=1, unit=uA_unit)
...
F = Unitful(val=1, unit=F_unit)
mF = Unitful(val=1, unit=mF_unit)
uF = Unitful(val=1, unit=uF_unit)
nF = Unitful(val=1, unit=nF_unit)
pF = Unitful(val=1, unit=pF_unit)
fF = Unitful(val=1, unit=fF_unit)
