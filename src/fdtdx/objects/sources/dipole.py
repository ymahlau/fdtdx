...
class PointDipoleSource(Source):
    ...
    _inv_eps_local: jax.Array = static_field()
    _inv_mu_local: jax.Array | float = static_field()
    _inv_eps_oriented: jax.Array = static_field()
    _inv_mu_oriented: jax.Array = static_field()
