...
class ParameterTransformation(DataClass, ABC):
    _input_type: dict[str, ParameterType] = static_private_field()
    _input_shape: dict[str, tuple[int, ...]] = static_private_field()
    _output_type: dict[str, ParameterType] = static_private_field()
    _output_shape: dict[str, tuple[int, ...]] = static_private_field()
    _materials: dict[str, Material] = static_private_field()
    _config: SimulationConfig = static_private_field()
    _matrix_voxel_grid_shape: tuple[int, int, int] = static_private_field()
    _single_voxel_size: tuple[float, float, float] = static_private_field()
