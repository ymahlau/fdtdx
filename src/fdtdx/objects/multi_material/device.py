...
from fdtdx.objects.multi_material.multi_material import ContinuousMultiMaterialObject, DiscreteMultiMaterialObject, MultiMaterialObject


@extended_autoinit
class BaseDeviceInterface(ExtendedTreeClass, ABC):
...
@extended_autoinit
class DiscreteDevice(DiscreteMultiMaterialObject, BaseDeviceInterface):
